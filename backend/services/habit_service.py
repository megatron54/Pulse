...
antes de escribir (mismo patrón que `services.food_log_service.
save_wger_token` - hallazgo de code-review: sin esto, en Postgres real
un `IntegrityError` de FK escaparía como 500 sin traducir en vez de un
404 limpio)."""
